...
CREATE TABLE "businesses" (
	...
	"town_id" integer,
	"generated_from_urls" text[] DEFAULT '{}' NOT NULL,
...
ALTER TABLE "links" ADD CONSTRAINT "links_business_id_businesses_id_fk" FOREIGN KEY ("business_id") REFERENCES "public"."businesses"("id") ON DELETE cascade ON UPDATE cascade;